...
<c:url var="saveUrl" value="/user/users/add" />
<form:form modelAttribute="userAttribute" method="POST" action="${saveUrl}">
	<table>
		<tr>
			<td><form:label path="userName">Kullanici Adi:</form:label></td>
			<td><form:input path="userName"/></td>
		</tr>

		<tr>
			<td><form:label path="password">Sifre</form:label></td>
			<td><form:input path="password"/></td>
		</tr>
		
		<tr>
			<td><form:label path="confirmPassword">Sifre Tekrar</form:label></td>
